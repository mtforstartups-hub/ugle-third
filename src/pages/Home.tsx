    ...
    <div className="pt-8 md:pt-12 border-t border-ugle-light/60 grid grid-cols-2 gap-8 md:gap-12 w-full max-w-2xl mx-auto text-center">
      {[
        ...
        },
        {
          ...
          value: "0%",
          context:
            "No AI tokens. No per-search fees. No monthly bill. Pay once.",
        },
        {
          metric: "Uptime",
          value: "100%",
        ...
        <div key={idx} className="flex flex-col">
          ...
          <div className="text-sm text-ugle-gray leading-tight font-medium max-w-[240px] mx-auto">
            {s.context}
          </div>
        </div>
      ))}
        ...
        >
          <div className="px-6 py-4 border-b border-ugle-light/60 flex items-center justify-between bg-[#F8FAF9]">
            <div className="flex items-center gap-3">
              {file?.icon && <file.icon className="w-5 h-5 text-ugle-green" />}
              <span className="font-semibold text-ugle-slate text-sm font-mono tracking-tight">
                {file?.file || "Preview"}
              </span>
            </div>
            <button
              onClick={onClose}
              className="p-2 hover:bg-white rounded-md border border-transparent hover:border-ugle-light/60 transition-colors text-ugle-gray hover:text-ugle-slate shadow-sm"
            >
              <X className="w-4 h-4" />
            </button>
          </div>
...
export default function Home() {
  ...
  const fileList = [
    {
      id: 1,
      file: "Interview_Alex_Final.mp4",
      type: "Video",
      icon: FileVideo,
      path: "/Users/taylor/Projects/Research",
      time: "10:34 AM",
      timestamp: 3,
    },
    {
      id: 2,
      file: "Board_Meeting_Q3.wav",
      type: "Audio",
      icon: FileVideo,
      path: "/Users/taylor/Projects/Internal",
      time: "09:12 AM",
      timestamp: 2,
    },
    {
      id: 3,
      file: "Source_Call_04.m4a",
      type: "Audio",
      icon: FileVideo,
      path: "/Users/taylor/Projects/Investigations",
      time: "Yesterday",
      timestamp: 1,
    },
  ];
      ...
      <section className="max-w-5xl mx-auto px-6 pt-16 md:pt-24 pb-16 md:pb-24 relative z-10 text-center">
        ...
        >
          <div className="space-y-6 flex flex-col items-center">
            ...
            >
              Ugle indexes every word spoken in your archive. Search by meaning
              in 30ms. Nothing leaves your device.
            </motion.p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-12 text-left">
            <div>
              ...
              <p className="text-white/70 text-lg leading-relaxed">
                Scrubbing three hours of tape to find a 40-second soundbite is
                not a workflow. It's time you don't have before the segment
                closes.
              </p>
            </div>
            <div>
              ...
              <p className="text-white/70 text-lg leading-relaxed">
                Source recordings are sensitive. The right search tool should
                not require handing them to a server you don't control.
              </p>
            </div>
            <div>
              <div className="w-12 h-1 bg-[#75C043] mb-6"></div>
